...
// Current contract addresses - Token to migrate FROM (Dec 27 deployment)
const ACTIVE_TOKEN = "0x5242925C716225C58459f557E5B4Be51373aB767";
const STAKING_CONTRACT = process.env.STAKING_CONTRACT_ADDRESS || "0x8D7817B77692Ad0B1D0D399F889A3158104291a5";
const EMISSIONS_CONTRACT = process.env.EMISSIONS_CONTRACT_ADDRESS || "0x6Dc42e62024F3f18d6fD91F662C19850c1BFD978";
const MERKLE_DISTRIBUTOR = process.env.MERKLE_DISTRIBUTOR_ADDRESS || "0xf74dF81441D120E4e4EF1c5bCa9bcde6f44256C8";
